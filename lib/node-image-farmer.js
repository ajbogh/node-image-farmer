...
exports = module.exports = function (opts) {
  ...
  return function thumbs(req, res, next) {
    ...
    decodeFn(encodedImageURL, function imageURLDecoding(err, decodedImageURL) {
      //check if the decodedImageUrl's extension is good
      if(!isExtensionAllowed(decodedImageURL, opts)){
        res.writeHead(403);
      ...
      function processFile() {
        ...
        try {
          ...
          console.log("Using existing full file:", filepath);
      ...
      function processFileStream(fileStream, useFilesystem, options){
        if(!useFilesystem){
          httpHandler.getFileHTTP(fileStream, request, decodedImageURL).then(function(){
...
function isExtensionAllowed(filePath, options){
